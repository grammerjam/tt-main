...
const FormSchema = Yup.object().shape({
  cardholderName: Yup.string().min(2).max(50, "Too Long!").required("Required"),
  cardNumber: Yup.string()
    .min(16, "Too Short!")
    .max(16, "Too Long!")
    .required("Required"),
  expirationMonth: Yup.string().min(2).max(2).required("Required"),
  expirationYear: Yup.string().min(2).max(2).required("Required"),
